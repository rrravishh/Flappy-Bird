...
# Functions
def draw_floor():
    screen.blit(floor_surface, (floor_x_pos, 855))
    screen.blit(floor_surface, (floor_x_pos + 576, 855))
...
def check_collision(pipes):
    ...
    if bird_rect.top <= -100 or bird_rect.bottom >= 855:
        return False
...
def score_display(game_state):
    ...
    if game_state == 'game_over':
        ...
        high_score_rect = high_score_surface.get_rect(center=(288, 810))
